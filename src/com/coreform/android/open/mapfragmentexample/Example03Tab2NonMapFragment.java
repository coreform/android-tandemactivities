...
public class Example03Tab2NonMapFragment extends Fragment {
	private static final boolean DEBUG = true;
	private static final String TAG = "Example03Tab2NonMapFragment";
	...
	public void onActivityCreated(Bundle savedInstanceState) {
        ...
        //((TandemActivitiesTabFragmentActivity)this.getActivity()).changeToTab("tab2");
        ...
        mHandler.post(new Runnable() {
			@Override
			public void run() {
				((TandemActivitiesTabFragmentActivity)Example03Tab2NonMapFragment.this.getActivity()).changeToTab("tab2");
			}
		});
		*/
	}
